                    ...
                    <div className="relative p-[1px] rounded-full bg-gradient-to-r from-green-200 via-emerald-200 to-slate-200 shadow-sm">
                        <div className="relative flex bg-white rounded-full p-1">
                            ...
                            <button
                                ...
                                className={`relative z-10 px-8 py-3 rounded-full font-bold text-lg transition-colors duration-300 min-w-[180px] ${persona === "students"
                                    ? "text-white"
                            ...
                            <button
                                ...
                                className={`relative z-10 px-8 py-3 rounded-full font-bold text-lg transition-colors duration-300 min-w-[180px] ${persona === "posters"
                                    ? "text-white"
                                    : "text-slate-600 hover:text-slate-900"
                                    }`}
                            >
                        ...
                        >
                            ...
                            {[
                                    ...
                                    visual: (
                                        <div className="bg-white p-6 rounded-2xl shadow-xl border border-slate-100 w-full max-w-sm mx-auto relative transform rotate-[-2deg] hover:rotate-0 transition-transform duration-500">
                                            <div className="flex items-center gap-4 mb-6">
                                                ...
                                                <div>
                                                    <div className="h-7 w-32 bg-blue-100 text-blue-600 font-bold rounded mb-2 px-3">Jack</div>
                                                    <div className="h-7 w-32 bg-slate-50 rounded">MERN Full Stack Developer</div>
                                                </div>
                                            </div>
                                            <div className="space-y-3 mt-5 ">
                                                <div className="flex gap-2 mt-5 ">
                                                    <span className="px-3 py-1 bg-blue-50 text-blue-600 text-xs rounded-full font-medium mt-5 ">
                                                        React
                                                    </span>
                                                    <span className="px-3 py-1 bg-purple-50 text-purple-600 text-xs rounded-full font-medium mt-5 ">
                                                        Design
                                                    </span>
                                                </div>
                                        ...
                                        <div className="bg-white p-6 rounded-2xl shadow-xl border border-slate-100 w-full max-w-sm mx-auto relative transform rotate-[2deg] hover:rotate-0 transition-transform duration-500">
                                            ...
                                            <div className="flex flex-wrap gap-2">
                                                {[
                                                    ...
                                                    <span
                                                        key={tag}
                                                        className="px-4 py-2 border border-slate-200 rounded-lg text-sm text-slate-600 hover:bg-green-300 cursor-pointer"
                                                    >
                                                        {tag}
                                                    </span>
                                                ))}
                                    ...
                                    visual: (
                                        <div className="bg-white p-4 rounded-2xl shadow-xl border border-slate-100 w-full max-w-sm mx-auto transform rotate-[-2deg] hover:rotate-0 transition-transform duration-500 ">
                                            {[1, 2].map((i) => (
                                                <div
                                                    key={i}
                                                    className="flex items-start gap-3 mb-4 last:mb-0 p-3 bg-slate-50 rounded-xl"
                                                >
                                                    ...
                                                    <button className="text-xs bg-green-200 text-green-600 px-3 py-1 rounded">
                                                        Accept
                                                    </button>
                                                    <button className="text-xs bg-red-200 text-red-600 px-3 py-1 rounded">
                                                        Reject
                                                    </button>
                                                </div>
                                            ))}
                                ...
                                },
                                {
                                    ...
                                    visual: (
                                        <div className="bg-gradient-to-br from-green-500 to-green-600 h-[280px] rounded-2xl shadow-xl w-full max-w-sm mx-auto text-white text-center transform rotate-[-2deg] hover:rotate-0 transition-transform duration-500">
                                            <div className="text-4xl font-bold pt-10 mb-1">
                                                ₹ 2,500
                                            </div>
                                            <div className="text-green-100 text-sm mb-6 mt-10">
                                                Available Balance
                                            </div>
                                            <button className="w-[160px] bg-white text-green-700 font-bold py-2 rounded-lg text-sm">
                                                Withdraw
                                            </button>
                                        </div>
                                    ),
