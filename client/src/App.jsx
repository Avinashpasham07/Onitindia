...
function App() {
  const [showTaskPerformer, setShowTaskPerformer] = useState(false);

  return (
    <Router>
      <div className="min-h-screen w-full bg-gray-100 overflow-hidden">
        <Navbar onShowTaskPerformer={() => setShowTaskPerformer(true)} />
          ...
          <Route
            ...
            element={
              !showTaskPerformer ? (
                ...
                <section id="taskperformers" className="scroll-mt-20">
                  <Task_Performers />
                </section>
              )
            }
